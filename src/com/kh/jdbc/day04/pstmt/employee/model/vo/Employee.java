...
public class Employee {
	...
	public Employee(String email, String phone, String deptCode, int salary, double bonus, String managerId) {
		super();
		this.email = email;
		this.phone = phone;
	...
	public String toString() {
		return "Employee [empId=" + empId + ", empName=" + empName + ", empNo=" + empNo + ", email=" + email
				...
				+ ", endDate=" + entDate + ", entYn=" + entYn + ", getEmpId()=" + getEmpId() + ", getEmpName()="
				+ getEmpName() + ", getEmpNo()=" + getEmpNo() + ", getEmail()=" + getEmail() + ", getPhone()="
				+ getPhone() + ", getDeptCode()=" + getDeptCode() + ", getJobCode()=" + getJobCode()
				+ ", getSalLevel()=" + getSalLevel() + ", getSalary()=" + getSalary() + ", getBonus()=" + getBonus()
				+ ", getManagerId()=" + getManagerId() + ", getHireDate()=" + getHireDate() + ", getEndDate()="
